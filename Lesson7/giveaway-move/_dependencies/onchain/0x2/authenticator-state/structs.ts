...
export function isAuthenticatorState(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V26}::authenticator_state::AuthenticatorState`; }
...
export class AuthenticatorState implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V26}::authenticator_state::AuthenticatorState`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AuthenticatorState.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::AuthenticatorState`; readonly $typeArgs: []; readonly $isPhantom = AuthenticatorState.$isPhantom;

 readonly id: ToField<UID>; readonly version: ToField<"u64">

 private constructor(typeArgs: [], fields: AuthenticatorStateFields, ) { this.$fullTypeName = composeSuiType( AuthenticatorState.$typeName, ...typeArgs ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorState`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.version = fields.version; }

 static reified( ): AuthenticatorStateReified { return { typeName: AuthenticatorState.$typeName, fullTypeName: composeSuiType( AuthenticatorState.$typeName, ...[] ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorState`, typeArgs: [ ] as [], isPhantom: AuthenticatorState.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AuthenticatorState.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AuthenticatorState.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AuthenticatorState.fromBcs( data, ), bcs: AuthenticatorState.bcs, fromJSONField: (field: any) => AuthenticatorState.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AuthenticatorState.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AuthenticatorState.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AuthenticatorState.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AuthenticatorState.fetch( client, id, ), new: ( fields: AuthenticatorStateFields, ) => { return new AuthenticatorState( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): AuthenticatorState { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAuthenticatorState(data.bcs.type)) { throw new Error(`object at is not a AuthenticatorState object`); }

 return AuthenticatorState.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AuthenticatorState.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isAuthenticatorStateInner(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V26}::authenticator_state::AuthenticatorStateInner`; }
...
export class AuthenticatorStateInner implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V26}::authenticator_state::AuthenticatorStateInner`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AuthenticatorStateInner.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::AuthenticatorStateInner`; readonly $typeArgs: []; readonly $isPhantom = AuthenticatorStateInner.$isPhantom;

 readonly version: ToField<"u64">; readonly activeJwks: ToField<Vector<ActiveJwk>>

 private constructor(typeArgs: [], fields: AuthenticatorStateInnerFields, ) { this.$fullTypeName = composeSuiType( AuthenticatorStateInner.$typeName, ...typeArgs ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorStateInner`; this.$typeArgs = typeArgs;

 this.version = fields.version;; this.activeJwks = fields.activeJwks; }

 static reified( ): AuthenticatorStateInnerReified { return { typeName: AuthenticatorStateInner.$typeName, fullTypeName: composeSuiType( AuthenticatorStateInner.$typeName, ...[] ) as `${typeof PKG_V26}::authenticator_state::AuthenticatorStateInner`, typeArgs: [ ] as [], isPhantom: AuthenticatorStateInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AuthenticatorStateInner.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AuthenticatorStateInner.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AuthenticatorStateInner.fromBcs( data, ), bcs: AuthenticatorStateInner.bcs, fromJSONField: (field: any) => AuthenticatorStateInner.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AuthenticatorStateInner.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AuthenticatorStateInner.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AuthenticatorStateInner.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AuthenticatorStateInner.fetch( client, id, ), new: ( fields: AuthenticatorStateInnerFields, ) => { return new AuthenticatorStateInner( [], fields ) }, kind: "StructClassReified", } }
 ...
 version: this.version.toString(),activeJwks: fieldToJSON<Vector<ActiveJwk>>(`vector<${ActiveJwk.$typeName}>`, this.activeJwks),
 ...
 static fromSuiObjectData( data: SuiObjectData ): AuthenticatorStateInner { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAuthenticatorStateInner(data.bcs.type)) { throw new Error(`object at is not a AuthenticatorStateInner object`); }

 return AuthenticatorStateInner.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AuthenticatorStateInner.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isJWK(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V26}::authenticator_state::JWK`; }
...
export class JWK implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V26}::authenticator_state::JWK`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JWK.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::JWK`; readonly $typeArgs: []; readonly $isPhantom = JWK.$isPhantom;

 readonly kty: ToField<String>; readonly e: ToField<String>; readonly n: ToField<String>; readonly alg: ToField<String>

 private constructor(typeArgs: [], fields: JWKFields, ) { this.$fullTypeName = composeSuiType( JWK.$typeName, ...typeArgs ) as `${typeof PKG_V26}::authenticator_state::JWK`; this.$typeArgs = typeArgs;

 this.kty = fields.kty;; this.e = fields.e;; this.n = fields.n;; this.alg = fields.alg; }

 static reified( ): JWKReified { return { typeName: JWK.$typeName, fullTypeName: composeSuiType( JWK.$typeName, ...[] ) as `${typeof PKG_V26}::authenticator_state::JWK`, typeArgs: [ ] as [], isPhantom: JWK.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JWK.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JWK.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JWK.fromBcs( data, ), bcs: JWK.bcs, fromJSONField: (field: any) => JWK.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JWK.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JWK.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JWK.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JWK.fetch( client, id, ), new: ( fields: JWKFields, ) => { return new JWK( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): JWK { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isJWK(data.bcs.type)) { throw new Error(`object at is not a JWK object`); }

 return JWK.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return JWK.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isJwkId(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V26}::authenticator_state::JwkId`; }

export interface JwkIdFields { iss: ToField<String>; kid: ToField<String> }

export type JwkIdReified = Reified< JwkId, JwkIdFields >;

export class JwkId implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V26}::authenticator_state::JwkId`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JwkId.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::JwkId`; readonly $typeArgs: []; readonly $isPhantom = JwkId.$isPhantom;

 readonly iss: ToField<String>; readonly kid: ToField<String>

 private constructor(typeArgs: [], fields: JwkIdFields, ) { this.$fullTypeName = composeSuiType( JwkId.$typeName, ...typeArgs ) as `${typeof PKG_V26}::authenticator_state::JwkId`; this.$typeArgs = typeArgs;

 this.iss = fields.iss;; this.kid = fields.kid; }

 static reified( ): JwkIdReified { return { typeName: JwkId.$typeName, fullTypeName: composeSuiType( JwkId.$typeName, ...[] ) as `${typeof PKG_V26}::authenticator_state::JwkId`, typeArgs: [ ] as [], isPhantom: JwkId.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JwkId.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JwkId.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JwkId.fromBcs( data, ), bcs: JwkId.bcs, fromJSONField: (field: any) => JwkId.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JwkId.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JwkId.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JwkId.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JwkId.fetch( client, id, ), new: ( fields: JwkIdFields, ) => { return new JwkId( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): JwkId { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isJwkId(data.bcs.type)) { throw new Error(`object at is not a JwkId object`); }

 return JwkId.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return JwkId.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export function isActiveJwk(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V26}::authenticator_state::ActiveJwk`; }
...
export class ActiveJwk implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V26}::authenticator_state::ActiveJwk`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ActiveJwk.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::authenticator_state::ActiveJwk`; readonly $typeArgs: []; readonly $isPhantom = ActiveJwk.$isPhantom;

 readonly jwkId: ToField<JwkId>; readonly jwk: ToField<JWK>; readonly epoch: ToField<"u64">

 private constructor(typeArgs: [], fields: ActiveJwkFields, ) { this.$fullTypeName = composeSuiType( ActiveJwk.$typeName, ...typeArgs ) as `${typeof PKG_V26}::authenticator_state::ActiveJwk`; this.$typeArgs = typeArgs;

 this.jwkId = fields.jwkId;; this.jwk = fields.jwk;; this.epoch = fields.epoch; }

 static reified( ): ActiveJwkReified { return { typeName: ActiveJwk.$typeName, fullTypeName: composeSuiType( ActiveJwk.$typeName, ...[] ) as `${typeof PKG_V26}::authenticator_state::ActiveJwk`, typeArgs: [ ] as [], isPhantom: ActiveJwk.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ActiveJwk.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ActiveJwk.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ActiveJwk.fromBcs( data, ), bcs: ActiveJwk.bcs, fromJSONField: (field: any) => ActiveJwk.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ActiveJwk.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ActiveJwk.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ActiveJwk.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ActiveJwk.fetch( client, id, ), new: ( fields: ActiveJwkFields, ) => { return new ActiveJwk( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): ActiveJwk { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isActiveJwk(data.bcs.type)) { throw new Error(`object at is not a ActiveJwk object`); }

 return ActiveJwk.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return ActiveJwk.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
