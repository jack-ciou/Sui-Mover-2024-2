...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::RuleKey` + '<'); }
...
export function isTransferRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::TransferRequest` + '<'); }
...
export function isTransferPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::TransferPolicy` + '<'); }
...
export function isTransferPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::TransferPolicyCap` + '<'); }
...
export function isTransferPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::TransferPolicyCreated` + '<'); }
...
export class TransferPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V26}::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`; readonly $typeArgs: [PhantomToTypeStr<T0>]; readonly $isPhantom = TransferPolicyCreated.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCreatedFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCreated.$typeName, ...typeArgs ) as `${typeof PKG_V26}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyCreatedReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicyCreated.$typeName, fullTypeName: composeSuiType( TransferPolicyCreated.$typeName, ...[extractType(T0)] ) as `${typeof PKG_V26}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], isPhantom: TransferPolicyCreated.$isPhantom, reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicyCreated.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCreated.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCreated.fromBcs( T0, data, ), bcs: TransferPolicyCreated.bcs, fromJSONField: (field: any) => TransferPolicyCreated.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCreated.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCreated.fromSuiParsedData( T0, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCreated.fromSuiObjectData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCreated.fetch( client, T0, id, ), new: ( fields: TransferPolicyCreatedFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicyCreated( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export function isTransferPolicyDestroyed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V26}::transfer_policy::TransferPolicyDestroyed` + '<'); }
...
export class TransferPolicyDestroyed<T0 extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V26}::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyDestroyed.$typeName; readonly $fullTypeName: `${typeof PKG_V26}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T0>}>`; readonly $typeArgs: [PhantomToTypeStr<T0>]; readonly $isPhantom = TransferPolicyDestroyed.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyDestroyedFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicyDestroyed.$typeName, ...typeArgs ) as `${typeof PKG_V26}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyDestroyedReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicyDestroyed.$typeName, fullTypeName: composeSuiType( TransferPolicyDestroyed.$typeName, ...[extractType(T0)] ) as `${typeof PKG_V26}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], isPhantom: TransferPolicyDestroyed.$isPhantom, reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicyDestroyed.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicyDestroyed.fromBcs( T0, data, ), bcs: TransferPolicyDestroyed.bcs, fromJSONField: (field: any) => TransferPolicyDestroyed.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyDestroyed.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData( T0, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyDestroyed.fromSuiObjectData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyDestroyed.fetch( client, T0, id, ), new: ( fields: TransferPolicyDestroyedFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicyDestroyed( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
